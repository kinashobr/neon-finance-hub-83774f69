...
const Index = () => {
  ...
  const evolucaoData = useMemo(() => {
    ...
    let patrimonioAcumulado = 200000;
    let investimentosAcumulados = 150000;
    let dividasAcumuladas = 90000;
